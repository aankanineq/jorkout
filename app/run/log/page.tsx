  ...
  return (
    <div className="p-4 max-w-lg mx-auto space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-sm text-white/60">타입</label>
          ...
          {RUN_TYPES.map((t) => (
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium ${
                runType === t ? 'bg-white text-black' : 'bg-white/10'
              }`}
            >
              {t}
            </button>
      ...
      {/* 거리 */}
      <div className="space-y-2">
        <label className="text-sm text-white/60">거리</label>
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder="0.0"
            className="bg-white/10 rounded-lg px-3 py-2 text-lg w-full"
          />
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder="00"
            className="bg-white/10 rounded-lg px-3 py-2 text-lg w-20 text-center"
          />
          <span>:</span>
          <input
            type="number"
